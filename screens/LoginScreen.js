        ...
        return (
            <View style={styles.container}>
                ...
                <Image source={require("../assets/authFooter.jpg")}
                    style={{ position: "absolute", bottom: 0, right: -225 }}
                >
                </Image>
                <Image source={require("../assets/loginLogo.jpg")}
                ...
                >
                    <Text style={{ color: "#415959", fontSize: 16 }}>
                        New to social app? <Text style={{ fontWeight: "500", color: "#E9446A" }}> Create an accout.</Text>
                    </Text>
                </TouchableOpacity>
            </View>
        )
